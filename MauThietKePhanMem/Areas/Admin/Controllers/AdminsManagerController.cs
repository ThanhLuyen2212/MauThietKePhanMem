...
namespace MauThietKePhanMem.Areas.Admin.Controllers
{
    public class AdminsManagerController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            MauThietKePhanMem.Models.Admin admin = db.Admins.Find(id);
            if (admin == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create([Bind(Include = "IDAdmin,TenAdmin,SDT,DiaChi,NgaySinh,UserName,Password")] MauThietKePhanMem.Models.Admin admin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDAdmin,TenAdmin,SDT,DiaChi,NgaySinh,UserName,Password")] MauThietKePhanMem.Models.Admin admin)
        {
            if (ModelState.IsValid)
            {
